...
integrations='none'
# the pre-trqined TTM checkpoints path
PRETRAINED='frozen-gpu_colbert-distilbert-margin_mse-T2-msmarco-bertonly_b4096_N50_K10_lr2e-3_SPLuni_TTM_car-windows_128_96_bert-base-uncased'
ckpt=50200
...
python  train/fine-tune/fine_tune_SenseEmbed--TTM.py \
